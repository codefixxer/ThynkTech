            ...
            <div class="container">
                <div class="top-features-slider overflow-hidden left-right-gradient position-relative">
                    <div class="d-flex align-items-center tw-gap-4">
                        ...
                        <span class="text-heading fw-medium tw-text-base">Create a premium CV/portfolio</span>
                    </div>
                    <div class="d-flex align-items-center tw-gap-4">
                        <span>
                            <img src="{{asset('assets/images/icons/chart-icon.svg')}}" alt="" />
                        </span>
                        <span class="text-heading fw-medium tw-text-base">Scope orders into milestones</span>
                    </div>
                    <div class="d-flex align-items-center tw-gap-4">
                        <span>
                            <img src="{{asset('assets/images/icons/chart-icon.svg')}}" alt="" />
                        </span>
                        <span class="text-heading fw-medium tw-text-base">Manage projects with your team</span>
                    </div>
                    <div class="d-flex align-items-center tw-gap-4">
                        <span>
                            <img src="{{asset('assets/images/icons/chart-icon.svg')}}" alt="" />
                        </span>
                        <span class="text-heading fw-medium tw-text-base">Send contracts & invoices</span>
                    </div>
                    <div class="d-flex align-items-center tw-gap-4">
                        <span>
                            <img src="{{asset('assets/images/icons/chart-icon.svg')}}" alt="" />
                        </span>
                        <span class="text-heading fw-medium tw-text-base">AI help at every step</span>
                    </div>
                </div>
            </div>
        </div>
