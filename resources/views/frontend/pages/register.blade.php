            ...
            <div class="container">
                <div class="max-w-514-px bg-white common-shadow-twentyOne tw-rounded-2xl tw-p-60-px mx-auto">
                    ...
                    <form action="#" class="form-submit d-flex flex-column tw-gap-6">
                        <div class="">
                            <label for="name" class="fw-semibold text-heading d-block tw-mb-105">Enter your name</label>
                            <input type="text"
                        ...
                        <div class="">
                            <label for="username" class="fw-semibold text-heading d-block tw-mb-105">Username</label>
                            <input type="text"
                                class="form-control bg-neutral-100 border border-neutral-100 focus-border-main-600 text-heading fw-medium tw-px-6 tw-py-4 tw-rounded-lg shadow-none"
                                id="username" placeholder="Enter username" />
                        </div>
                        <div class="">
                            <label for="enterEmail" class="fw-semibold text-heading d-block tw-mb-105">Enter your
                                email</label>
                            <input type="email"
                                class="form-control bg-neutral-100 border border-neutral-100 focus-border-main-600 text-heading fw-medium tw-px-6 tw-py-4 tw-rounded-lg shadow-none"
                                id="enterEmail" placeholder="Enter your email" />
                        </div>
                        <div class="">
                            <label for="createPassword" class="fw-medium text-base text-neutral-800 tw-mb-3">
                                Create password</label>
                            <div class="position-relative">
                                <input type="text"
                                    class="form-control bg-neutral-100 border border-neutral-100 focus-border-main-600 text-heading fw-medium tw-px-6 tw-py-4 tw-rounded-lg shadow-none"
                                    id="createPassword" placeholder="Enter your name" />
                                <span
                        ...
                        <div class="">
                            <label for="confirmPassword" class="fw-medium text-base text-neutral-800 tw-mb-3">Confirm
                                Password</label>
                            <div class="position-relative">
                                <input type="text"
                                    class="form-control bg-neutral-100 border border-neutral-100 focus-border-main-600 text-heading fw-medium tw-px-6 tw-py-4 tw-rounded-lg shadow-none"
                        ...
                        <div class="common-check d-flex align-items-center tw-gap-2">
                            ...
                            <div class="form-check-label text-neutral-600 fw-semibold">
                                <label class="" for="remember">
                                    I agree to sassly</label>
                                <a href="javascript:void(0)"
                                    class="text-decoration-underline text-neutral-600 fw-semibold hover--translate-y-1 active-scale-09 hover-text-main-600">Terms
                                    of Service.</a>
                            </div>
                        </div>
                        <div class="">
